...
def read_beds(sense, dir, assemblies=None):
    """
     Read all BED files in a given directory
    ...
    # In the above we assumed that any Ds were in the - orientation. If sense was specified as +-, check the sense
