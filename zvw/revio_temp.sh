...
/home/egenge01/minimap2/minimap2 -ax map-hifi -t 12 -L /home/egenge01/projects/IGL_ref_mod/reference_ready/modified_reference_renamed.fasta ${scratch}/ccs_reads.fasta > ${scratch}/output.sam
